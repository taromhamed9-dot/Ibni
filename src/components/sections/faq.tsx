...
const FAQS = [
  {
    q: "ما هو إبني؟",
    a: "إبني منصة تعليمية تفاعلية للأطفال العرب من ٥ إلى ١٠ سنوات. تجمع بين الذكاء الاصطناعي والألعاب التربوية والقصص العربية والقيم الإسلامية، لتقديم بديل آمن وممتع لإدمان الشاشات.",
  },
  {
  ...
  {
    q: "كيف أشترك؟",
    a: "اضغط زر «ابدأ مجاناً»، أنشئ حساب العائلة في أقل من دقيقة، أضف طفلك، واختر الخطة المناسبة. تجربة ١٤ يوماً مجانية بدون بطاقة بنكية.",
  },
];
